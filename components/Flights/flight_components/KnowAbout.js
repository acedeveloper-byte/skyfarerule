                ...
                <div className="col-lg-7">
                    <div>
                        ...
                        <div className="d-flex align-items-center mb-4">
                            <a href="about-us.html" className="btn btn-dark me-3">Get Started<i className="isax isax-arrow-right-3 ms-2"></i></a>
                            <a data-fancybox="" href="" className="btn btn-white"><i className="isax isax-play-circle5 me-2"></i>Watch Video</a>
                        </div>
