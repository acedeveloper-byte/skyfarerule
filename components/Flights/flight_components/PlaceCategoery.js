            ...
            <div className="row justify-content-center">
                <div className="col-md-8 wow fadeInUp" data-wow-delay="0.2s">
                    <div className="section-header-six">
                        <span className="badge badge-soft-primary rounded-pill mb-1">Top Rated Tours</span>
                        <h2>Popular Tours Around the World<span className="text-primary">.</span></h2>
                    </div>
                </div>
                <div className="col-md-4">
                    <div className="text-end">
                        <a href="tour-grid.html" className="btn btn-dark sec-head-btn">View All Categories<i className="isax isax-arrow-right-3 ms-2"></i></a>
                    </div>
                </div>
            </div>
            <div className="cars-slider owl-dot-bottom owl-carousel wow fadeInUp" data-wow-delay="1.5">
                ...
                <div className="place-item mb-4 flex-fill">
                        ...
                        <div className="img-slider image-slide owl-carousel nav-center">
                            <div className="slide-images">
                                <a href="tour-details.html">
                                    <img src="/img/tours/tours-07.jpg" className="img-fluid" alt="img" />
                                </a>
                            </div>
                            <div className="slide-images">
                                <a href="tour-details.html">
                                    <img src="/img/tours/tours-08.jpg" className="img-fluid" alt="img" />
                                </a>
                            </div>
                            <div className="slide-images">
                                <a href="tour-details.html">
                                    <img src="/img/tours/tours-09.jpg" className="img-fluid" alt="img" />
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="place-content">
                        ...
                        <h5 className="mb-1 text-truncate"><a href="tour-details.html">Rainbow Mountain Valley</a></h5>
                        ...
                        <div className="d-flex align-items-center justify-content-between border-top pt-3">
                            ...
                            <div className="ms-2 d-flex align-items-center">
                                ...
                                <a href="javascript:void(0);" className="avatar avatar-sm ms-3">
                ...
                <div className="place-item mb-4 flex-fill">
                    <div className="place-img">
                        <div className="img-slider image-slide owl-carousel nav-center">
                            ...
                            <div className="slide-images">
                                <a href="tour-details.html">
                                    <img src="/img/tours/tours-10.jpg" className="img-fluid" alt="img" />
                                </a>
                            </div>
                        </div>
                        <div className="fav-item">
                    ...
                    <div className="place-content">
                        ...
                        <h5 className="mb-1 text-truncate"><a href="tour-details.html">Mystic Falls</a></h5>
                ...
                <div className="place-item mb-4 flex-fill">
                    <div className="place-img">
                        <div className="img-slider image-slide owl-carousel nav-center">
                            ...
                            <div className="slide-images">
                                <a href="tour-details.html">
                                    <img src="/img/tours/tours-11.jpg" className="img-fluid" alt="img" />
                                </a>
                            </div>
                        </div>
                        <div className="fav-item">
                    ...
                    <div className="place-content">
                        ...
                        <h5 className="mb-1 text-truncate"><a href="tour-details.html">Crystal Lake</a></h5>
                ...
                <div className="place-item mb-4 flex-fill">
                    <div className="place-img">
                        <div className="img-slider image-slide owl-carousel nav-center">
                            ...
                            <div className="slide-images">
                                <a href="tour-details.html">
                                    <img src="/img/tours/tours-12.jpg" className="img-fluid" alt="img" />
                                </a>
                            </div>
                        </div>
                        <div className="fav-item">
                    ...
                    <div className="place-content">
                        ...
                        <h5 className="mb-1 text-truncate"><a href="tour-details.html">Majestic Peaks</a></h5>
                ...
                <div className="place-item mb-4 flex-fill">
                    <div className="place-img">
                        <div className="img-slider image-slide owl-carousel nav-center">
                            ...
                            <div className="slide-images">
                                <a href="tour-details.html">
                                    <img src="/img/tours/tours-13.jpg" className="img-fluid" alt="img" />
                                </a>
                            </div>
                        </div>
                        <div className="fav-item">
                    ...
                    <div className="place-content">
                        ...
                        <h5 className="mb-1 text-truncate"><a href="tour-details.html">Enchanted Forest</a></h5>
                ...
                <div className="place-item mb-4 flex-fill">
                    <div className="place-img">
                        <div className="img-slider image-slide owl-carousel nav-center">
                            ...
                            <div className="slide-images">
                                <a href="tour-details.html">
                                    <img src="/img/tours/tours-14.jpg" className="img-fluid" alt="img" />
                                </a>
                            </div>
                        </div>
                        <div className="fav-item">
                    ...
                    <div className="place-content">
                        <div className="d-flex align-items-center justify-content-between mb-1">
                            <div className="d-flex flex-wrap align-items-center">
                                <span className="me-1"><i className="ti ti-receipt text-primary"></i></span>
                                <p className="fs-14 text-gray-9 text-truncate">Beach Tours</p>
                            </div>
                            <span className="d-inline-block border vertical-splits">
								<span className="bg-light text-light d-flex align-items-center justify-content-center"></span>
                            </span>
                        ...
                        <h5 className="mb-1 text-truncate"><a href="tour-details.html">Serene Bay</a></h5>
                        <p className="d-flex align-items-center mb-3"><i className="isax isax-location5 me-2"></i>Bold Street, Liverpool</p>
                        <div className="mb-3">
                            <h6 className="d-flex align-items-center text-gray-6 fs-14 fw-normal">Starts From <span className="ms-1 fs-18 fw-semibold text-primary">$450</span><span className="ms-1 fs-18 fw-semibold text-gray-3 text-decoration-line-through">$520</span></h6>
                        </div>
                        <div className="d-flex align-items-center justify-content-between border-top pt-3">
                            <div className="d-flex flex-wrap align-items-center me-2">
                                <span className="me-1"><i className="isax isax-calendar-tick text-gray-6"></i></span>
                            ...
                            <div className="ms-2 d-flex align-items-center">
                                <p className="fs-14 text-gray-9 mb-0 text-truncate d-flex align-items-center">
                                    <i className="isax isax-profile-2user me-1"></i>08 Guests
                                </p>
                                <a href="javascript:void(0);" className="avatar avatar-sm ms-3">
                ...
                <div className="place-item mb-4 flex-fill">
                    <div className="place-img">
                        <div className="img-slider image-slide owl-carousel nav-center">
                            ...
                            <div className="slide-images">
                                <a href="tour-details.html">
                                    <img src="/img/tours/tours-15.jpg" className="img-fluid" alt="img" />
                                </a>
                            </div>
                        </div>
                        <div className="fav-item">
                    ...
                    <div className="place-content">
                        <div className="d-flex align-items-center justify-content-between mb-1">
                            <div className="d-flex flex-wrap align-items-center">
                                <span className="me-1"><i className="ti ti-receipt text-primary"></i></span>
                                <p className="fs-14 text-gray-9 text-truncate">Historical Tours</p>
                            </div>
                            <span className="d-inline-block border vertical-splits">
								<span className="bg-light text-light d-flex align-items-center justify-content-center"></span>
                            </span>
                        ...
                        <h5 className="mb-1 text-truncate"><a href="tour-details.html">Ancient Ruins</a></h5>
                        <p className="d-flex align-items-center mb-3"><i className="isax isax-location5 me-2"></i>Broad Street, Bristol</p>
                        <div className="mb-3">
                            <h6 className="d-flex align-items-center text-gray-6 fs-14 fw-normal">Starts From <span className="ms-1 fs-18 fw-semibold text-primary">$350</span><span className="ms-1 fs-18 fw-semibold text-gray-3 text-decoration-line-through">$400</span></h6>
                        </div>
                        <div className="d-flex align-items-center justify-content-between border-top pt-3">
                            <div className="d-flex flex-wrap align-items-center me-2">
                                <span className="me-1"><i className="isax isax-calendar-tick text-gray-6"></i></span>
