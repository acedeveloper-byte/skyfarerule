                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            ...
                            <div className="listing-img">
                                ...
                                <div className="about-img">
                                    <img src="/images/about/about-us.png" alt="about" />
                                </div>
                        ...
                        <div className="col-lg-6">
                            <div className="about-content mb-4">
                                <h6 className="text-primary fs-14 fw-medium mb-2">About SkyfareRules</h6>
                                <h4 className=" mb-2">Hello, and thank you for choosing Sky Fare Rules!</h4>
                                <p className="mb-4">As the leading online travel agency, we offer our global passengers the opportunity to get the cheapest airline tickets and the best available deals and discounts through our authorized and verified third-party airline providers. Our mission is to make travel easy and affordable for everyone, helping customers book trips hassle-free and experience outstanding service in the process.</p>
